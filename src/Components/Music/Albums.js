...
const Albums = ({
  ...
  return (
    <div className=" flex flex-col justify-center flex-wrap p-2 pl-4">
      <div className="dark:text-white text-black text-2xl my-5">Albums</div>
      <div className="flex w-full flex-row justify-start place-items-center overflow-y-hidden  overflow-scroll gap-x-2 overflow-x-scroll max-h-[30vh]">
        {data &&
